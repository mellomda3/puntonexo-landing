...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.2.4' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.2.4/PuntoNexo-Installer-2.2.4.exe' }
