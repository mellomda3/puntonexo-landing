...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.8.4' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.8.4/PuntoNexo-Installer-2.8.4.exe' }
