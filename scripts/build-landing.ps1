...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.8.3' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.8.3/PuntoNexo-Installer-2.8.3.exe' }
