...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.2.9' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.2.9/PuntoNexo-Installer-2.2.9.exe' }
