...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.4.0' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.4.0/PuntoNexo-Installer-2.4.0.exe' }
