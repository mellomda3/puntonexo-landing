...
if (-not $ReleaseVersion) { $ReleaseVersion = '2.8.9' }
if (-not $ReleaseDownloadUrl) { $ReleaseDownloadUrl = 'https://github.com/mellomda3/puntonexo-releases/releases/download/v2.8.9/PuntoNexo-Installer-2.8.9.exe' }
